    ...
    <div className="min-h-screen bg-gradient-to-br from-white to-[#FFF5F5] flex items-center justify-center px-4">
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-xl shadow-lg">
        <div>
          ...
          <p className="mt-2 text-center text-black">Sign in to your account</p>
        </div>
        ...
        <div className="text-center space-y-4">
          ...
          <div className="flex justify-center space-x-4">
            <Link 
              href="/login" 
              className={`text-sm ${userType === 'company' ? 'text-[#F37172]' : 'text-black'} hover:text-[#F37172]`}
            >
              Company Login
            </Link>
            ...
            <Link 
              href="/login" 
              className={`text-sm ${userType === 'user' ? 'text-[#F37172]' : 'text-black'} hover:text-[#F37172]`}
            >
              Job Seeker Login
            </Link>
          </div>
